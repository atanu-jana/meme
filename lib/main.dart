...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: block.darkTheme,
      initialData: false,
      builder: (context, snapsort) => MaterialApp(
        debugShowCheckedModeBanner: false,
        title: 'Meme',
        theme: snapsort.data ? ThemeData.dark() : ThemeData.light(),
        home: HomePage(darkTheme: snapsort.data,),
      ),
    );
  }
}
